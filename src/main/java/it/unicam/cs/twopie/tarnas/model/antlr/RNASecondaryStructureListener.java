...
public interface RNASecondaryStructureListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link RNASecondaryStructureParser#db}.
	 * @param ctx the parse tree
	 */
	void enterDb(RNASecondaryStructureParser.DbContext ctx);
	/**
	 * Exit a parse tree produced by {@link RNASecondaryStructureParser#db}.
	 * @param ctx the parse tree
	 */
	void exitDb(RNASecondaryStructureParser.DbContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code dbStructureContinue}
	 * labeled alternative in {@link RNASecondaryStructureParser#db_structure}.
	 * @param ctx the parse tree
	 */
	void enterDbStructureContinue(RNASecondaryStructureParser.DbStructureContinueContext ctx);
	/**
	 * Exit a parse tree produced by the {@code dbStructureContinue}
	 * labeled alternative in {@link RNASecondaryStructureParser#db_structure}.
	 * @param ctx the parse tree
	 */
	void exitDbStructureContinue(RNASecondaryStructureParser.DbStructureContinueContext ctx);
	/**
	 * Enter a parse tree produced by the {@code dbStructureEnd}
	 * labeled alternative in {@link RNASecondaryStructureParser#db_structure}.
	 * @param ctx the parse tree
	 */
	void enterDbStructureEnd(RNASecondaryStructureParser.DbStructureEndContext ctx);
	/**
	 * Exit a parse tree produced by the {@code dbStructureEnd}
	 * labeled alternative in {@link RNASecondaryStructureParser#db_structure}.
	 * @param ctx the parse tree
	 */
	void exitDbStructureEnd(RNASecondaryStructureParser.DbStructureEndContext ctx);
	/**
	 * Enter a parse tree produced by {@link RNASecondaryStructureParser#header}.
	 * @param ctx the parse tree
	 */
	void enterHeader(RNASecondaryStructureParser.HeaderContext ctx);
	/**
	 * Exit a parse tree produced by {@link RNASecondaryStructureParser#header}.
	 * @param ctx the parse tree
	 */
	void exitHeader(RNASecondaryStructureParser.HeaderContext ctx);
	/**
